...
export const subcategoryImages: Record<string, SubcategoryImageSource> = {
  ...
  [key("Health & Beauty", "Makeup & Cosmetics")]: { image: download("RS49PbJ3st4"), source: "unsplash", license: "Unsplash License" },
  [key("Health & Beauty", "Fragrances")]: { image: download("MRadukzuTSM"), source: "unsplash", license: "Unsplash License" },
  [key("Health & Beauty", "Health & Wellness")]: { image: download("LlC_feChWqc"), source: "unsplash", license: "Unsplash License" },
  [key("Health & Beauty", "Personal Care")]: { image: download("2c5R1rXF3sQ"), source: "unsplash", license: "Unsplash License" },

  [key("Toys & Games", "Action Figures")]: { image: download("sR1BaDlRSKM"), source: "unsplash", license: "Unsplash License" },
  [key("Toys & Games", "Board Games")]: { image: download("mWcSBg1zb8o"), source: "unsplash", license: "Unsplash License" },
  [key("Toys & Games", "Educational Toys")]: { image: download("rzdiMC4kiqw"), source: "unsplash", license: "Unsplash License" },
  [key("Toys & Games", "Outdoor Toys")]: { image: download("ibPFDW1iVBY"), source: "unsplash", license: "Unsplash License" },
  [key("Toys & Games", "Dolls & Playsets")]: { image: download("uoHql3MUu80"), source: "unsplash", license: "Unsplash License" },
  [key("Toys & Games", "Puzzles")]: { image: download("dmlM6x_pR64"), source: "unsplash", license: "Unsplash License" },

  [key("Food & Drink", "Snacks & Confectionery")]: { image: download("ZouNrDx0JaU"), source: "unsplash", license: "Unsplash License" },
  [key("Food & Drink", "Beverages")]: { image: download("Px0oEPRaXtg"), source: "unsplash", license: "Unsplash License" },
  [key("Food & Drink", "Canned & Dry Goods")]: { image: download("CBxpsG359I0"), source: "unsplash", license: "Unsplash License" },
  [key("Food & Drink", "Health Foods")]: { image: download("s7ea5VDFaMw"), source: "unsplash", license: "Unsplash License" },
  [key("Food & Drink", "Specialty & Gourmet")]: { image: download("PuTuY_TDM7g"), source: "unsplash", license: "Unsplash License" },
  [key("Food & Drink", "Seasonal")]: { image: download("Pn-kJ9Bj-EU"), source: "unsplash", license: "Unsplash License" },

  [key("Tools & DIY", "Power Tools")]: { image: download("wynkDtIrGlI"), source: "unsplash", license: "Unsplash License" },
  [key("Tools & DIY", "Hand Tools")]: { image: download("Z3vFp7szCAY"), source: "unsplash", license: "Unsplash License" },
  [key("Tools & DIY", "Plumbing")]: { image: download("8BAyCFRCHqY"), source: "unsplash", license: "Unsplash License" },
  [key("Tools & DIY", "Electrical")]: { image: download("vT9zeLCOpps"), source: "unsplash", license: "Unsplash License" },
  [key("Tools & DIY", "Paint & Decorating")]: { image: download("xMYqVhgKrrg"), source: "unsplash", license: "Unsplash License" },
  [key("Tools & DIY", "Fixings & Hardware")]: { image: download("0XeINWr8Phg"), source: "unsplash", license: "Unsplash License" },
