...
function buildBrief(categorySlug: string, categoryLabel: string, subcategoryLabel: string): string {
...
export const WHOLESALE_SUBCATEGORY_VISUAL_MANIFEST: WholesaleSubcategoryVisualManifestEntry[] =
  WHOLESALE_VISUAL_TAXONOMY.flatMap((category) =>
    category.subcategories.map((subcategory) => ({
      ...
      visualBrief: buildBrief(category.slug, category.label, subcategory.label),
    })),
  );
