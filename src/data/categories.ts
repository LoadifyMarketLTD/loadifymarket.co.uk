...
export const CATEGORIES: readonly Category[] = [
  ...
  // 4 ── Cleaning ─────────────────────────────────────────────────────────────
  {
    ...
    featured: false,
    subcategories: [
      { name: "Cleaning Wipes & Sprays",   slug: "cleaning-wipes-sprays"   },
      { name: "Sponges, Scourers & Cloths", slug: "sponges-scourers-cloths" },
      { name: "Brooms, Mops & Brushes",    slug: "brooms-mops-brushes"     },
      { name: "Laundry Supplies",          slug: "laundry-supplies"         },
      { name: "Dehumidifiers",             slug: "dehumidifiers"            },
      { name: "Cleaning Gloves",           slug: "cleaning-gloves"          },
      { name: "Sinks & Drains",            slug: "sinks-drains"             },
      { name: "Bins",                      slug: "bins"                     },
      { name: "Bowls & Storage",           slug: "bowls-storage"            },
    ],
  },
  ...
  // 6 ── Wholesale Pound Lines ────────────────────────────────────────────────
  {
    ...
    featured: true,
    subcategories: [
      { name: "Toy Pound Lines",               slug: "toy-pound-lines"               },
      { name: "Stationery Pound Lines",         slug: "stationery-pound-lines"        },
      { name: "DIY Pound Lines",               slug: "diy-pound-lines"               },
      { name: "Homeware Pound Lines",          slug: "homeware-pound-lines"          },
      { name: "Garden Pound Lines",            slug: "garden-pound-lines"            },
      { name: "Pet Pound Lines",               slug: "pet-pound-lines"               },
      { name: "Baby Pound Lines",              slug: "baby-pound-lines"              },
      { name: "Clothing Pound Lines",          slug: "clothing-pound-lines"          },
      { name: "Health & Beauty Pound Lines",   slug: "health-beauty-pound-lines"     },
      { name: "Kitchenware Pound Lines",       slug: "kitchenware-pound-lines"       },
      { name: "Party & Gift Pound Lines",      slug: "party-gift-pound-lines"        },
      { name: "Electrical Pound Lines",        slug: "electrical-pound-lines"        },
      { name: "Seasonal Pound Lines",          slug: "seasonal-pound-lines"          },
      { name: "Leisure & Hobbies Pound Lines", slug: "leisure-hobbies-pound-lines"   },
      { name: "Cleaning Pound Lines",          slug: "cleaning-pound-lines"          },
    ],
  },
