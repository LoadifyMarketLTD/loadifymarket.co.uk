      ...
      <section className="py-12 bg-graphite/30">
        <div className="container-cinematic text-center">
          <h1 className="heading-hero text-white mb-6">
            About <span className="text-gradient-gold">LoadifyMarket</span>
          </h1>
        ...
        <div className="container-cinematic max-w-4xl">
          <div className="card-glass">
            ...
            <div className="space-y-4 text-white/70 text-lg leading-relaxed">
              <p>
                LoadifyMarket was born from a simple observation: the UK needed a better way to
              ...
              <p>
                Founded by Danny Courier LTD in Blackburn, we set out to build more than just
              ...
              <p>
                Today, LoadifyMarket serves thousands of businesses across the UK, from small
        ...
        <div className="container-cinematic max-w-4xl">
          <div className="card-glass">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Danny Courier LTD</h2>
        ...
        <div className="container-cinematic text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-white/60 text-lg mb-8">
              Whether you're buying or selling, LoadifyMarket is here to help you succeed.
            </p>
