...
const TermsAndConditions = () => {
  return (
    <MainLayout>
      <SEO title="Terms & Conditions | Loadify Market" description="Read the full terms and conditions for using Loadify Market — the UK's online marketplace." canonical="/terms" />
