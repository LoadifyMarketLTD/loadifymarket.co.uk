    ...
    <MainLayout>
      ...
      <main id="main-content" className="pt-4 md:pt-28 pb-20">
        ...
        <div className="container mx-auto px-4 max-w-4xl prose prose-slate dark:prose-invert prose-headings:font-display">
          ...
          <p>Loadify Market is UK-based, but international sellers may apply and sell on the Platform if they comply with UK laws, Stripe requirements, marketplace rules, intellectual property regulations, shipping obligations, and consumer protection requirements.</p>
          ...
          <ul>
            ...
            <li>Comply with Stripe policies and payment-provider requirements</li>
          ...
          <p>Listings that breach this rule may be removed immediately, and related seller accounts may be suspended or terminated without notice.</p>
          ...
          <h2>9. Seller Moderation &amp; Enforcement Rights</h2>
          <p>To protect buyers, sellers, payment operations and legal compliance, Loadify Market reserves the right to:</p>
          <ul>
            <li>Manually review suspicious listings, seller activity, or account behaviour</li>
            <li>Suspend, restrict, or permanently remove sellers that breach Platform policies or legal requirements</li>
            <li>Remove prohibited products or listings without prior notice</li>
            <li>Cooperate with payment providers (including Stripe), regulators, and law-enforcement authorities where legally required</li>
          </ul>
