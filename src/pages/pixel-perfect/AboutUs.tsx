...
const AboutUs = () => {
  return (
    <MainLayout>
      <SEO title="About Us | Loadify Market" description="Learn about Loadify Market — the UK's online marketplace connecting independent buyers and sellers." canonical="/about" />
