  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Connect your Stripe Express account from the Payouts tab. After the protection period, the order is settled to Stripe less the actual processing fee, Loadify commission and any evidenced adjustments. Standard bank payouts are grouped weekly, normally Friday, once the connected balance reaches £25.",
      },
      {
        question: "What commission does Loadify Market charge?",
        answer:
          "Loadify commission is 0% through 31 December 2026 and 7% from 1 January 2027. The seller separately bears the actual Stripe processing fee and any actual attributable Connect or payout cost. Each deduction is shown in the seller settlement statement.",
      },
      {
