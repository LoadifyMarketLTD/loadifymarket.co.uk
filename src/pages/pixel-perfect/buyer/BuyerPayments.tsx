    ...
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="rounded-lg bg-primary/5 border border-primary/20 p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            All payments are encrypted and processed via Stripe at checkout. We never store your card number on this platform.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16 text-muted-foreground text-center gap-3">
          ...
          <div>
            <p className="text-base font-medium text-foreground">Payments are processed at checkout via Stripe</p>
            <p className="text-sm mt-1 max-w-sm">
              No card details are stored here. Your payment history is shown against each order in the Orders section.
            </p>
          </div>
        </CardContent>
      </Card>
