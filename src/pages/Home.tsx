        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://twitter.com/loadifymarket" aria-label="X (formerly Twitter)" target="_blank" rel="noopener noreferrer" className="hover:text-slate-800">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://facebook.com/loadifymarket" aria-label="Facebook" target="_blank" rel="noopener noreferrer" className="hover:text-slate-800">
              ...
              <a href="https://instagram.com/loadifymarket" aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="hover:text-slate-800">
