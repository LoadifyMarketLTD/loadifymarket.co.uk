  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="card prose max-w-full">
        ...
        <p>
          XDrive Logistics Ltd ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy 
          explains how we collect, use, and protect your personal information when you use XDrive Logistics Ltd.
        </p>
