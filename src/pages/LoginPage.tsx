      ...
      <div className="w-full max-w-md">
        <div className="card-glass p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60 text-sm">Welcome back to XDrive Market Logistics by XDrive Logistics Ltd</p>
          </div>
          ...
          <div className="mt-8 mb-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-graphite text-white/60">New to XDrive Market Logistics by XDrive Logistics Ltd?</span>
              </div>
            </div>
          </div>
