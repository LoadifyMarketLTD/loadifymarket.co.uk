    ...
    <div className="bg-[#F8F9FA] min-h-screen pt-24">
      ...
      <div className="container-cinematic py-16 max-w-5xl">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">When Are You Protected?</h2>
        ...
        {/* Dispute process */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">How the Dispute Process Works</h2>
              ...
              {DISPUTE_TIMELINE.map((event, i) => (
                <div key={i} className="flex-1 flex flex-col items-center text-center p-4 relative z-10">
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 font-bold text-sm ${
                    event.isDeadline ? 'bg-gold/20 border-2 border-gold text-gold' : 'bg-white text-gray-500'
                  }`}>
                    Day {event.day}
                  </div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4 text-sm">
            ...
            <div className="flex items-start gap-3">
              <ChevronRight className="w-4 h-4 text-gold shrink-0 mt-0.5" />
              <p className="text-gray-600">Handmade, custom, and digital items may have different return conditions as specified on the product listing.</p>
            </div>
          </div>
        </section>
