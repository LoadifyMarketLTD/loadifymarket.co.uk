        ...
        <section className="relative overflow-hidden border-b border-[#0A234F]/10 pt-28 lg:pt-32">
          ...
          <div className="mx-auto grid min-h-[700px] max-w-[1480px] items-center gap-14 px-6 py-16 lg:grid-cols-12 lg:px-10 lg:py-20">
            <div className="relative lg:col-span-7">
              ...
              <div className="mt-9 flex flex-wrap gap-3"><Link to="/marketplace" className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-[#0A234F] px-6 py-3 text-sm font-extrabold text-white transition hover:bg-[#071A3C]">Open Marketplace <ArrowRight className="h-4 w-4" aria-hidden="true" /></Link><Link to="/platform" className="inline-flex min-h-12 items-center rounded-lg border border-[#0A234F]/15 bg-white px-6 py-3 text-sm font-extrabold text-[#0A234F] transition hover:border-[#0A234F]/25">Explore the Platform</Link></div>
