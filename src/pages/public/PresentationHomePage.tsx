        ...
        <section className="relative overflow-hidden border-b border-[#0A234F]/10 pt-28 lg:pt-32">
          ...
          <div className="mx-auto grid min-h-[700px] w-full min-w-0 max-w-[1480px] items-center gap-14 px-6 py-16 lg:grid-cols-12 lg:px-10 lg:py-20">
            <div className="relative min-w-0 lg:col-span-7">
              ...
              <h1 className="mt-5 max-w-[900px] break-words font-serif text-[2.65rem] font-normal leading-[0.98] tracking-[-0.045em] text-[#0A234F] sm:text-[4.4rem] lg:text-[5.25rem]">A marketplace built to connect buying, selling and business commerce.</h1>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap"><Link to="/marketplace" className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-lg bg-[#0A234F] px-6 py-3 text-sm font-extrabold text-white transition hover:bg-[#071A3C] sm:w-auto">Open Marketplace <ArrowRight className="h-4 w-4" aria-hidden="true" /></Link><Link to="/platform" className="inline-flex min-h-12 w-full items-center justify-center rounded-lg border border-[#0A234F]/15 bg-white px-6 py-3 text-sm font-extrabold text-[#0A234F] transition hover:border-[#0A234F]/25 sm:w-auto">Explore the Platform</Link></div>
              <div className="mt-10 grid max-w-[760px] gap-3 border-t border-[#0A234F]/10 pt-6 sm:grid-cols-3">{["Marketplace buying", "Seller operations", "Business participation"].map((item) => <div key={item} className="flex items-center gap-2 text-sm font-bold text-[#536174]"><CheckCircle2 className="h-4 w-4 shrink-0 text-[#8A7351]" aria-hidden="true" />{item}</div>)}</div>
            </div>
            <div className="relative min-w-0 lg:col-span-5">
              <div className="rounded-[30px] bg-[#0A234F] p-8 text-white shadow-[0_28px_80px_rgba(10,35,79,0.16)]">
                <div className="flex items-center justify-between gap-4 border-b border-white/10 pb-5"><div><p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#F5A300]">LOADIFY PLATFORM MAP</p><h2 className="mt-3 font-serif text-3xl font-normal leading-[1.08] tracking-[-0.03em] text-white">One commerce journey, clear operating areas.</h2></div><span className="rounded-full bg-[#F5A300] px-3 py-1 text-[10px] font-black text-[#0A234F]">LOADIFY</span></div>
