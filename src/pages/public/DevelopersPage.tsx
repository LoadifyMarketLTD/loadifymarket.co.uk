...
export default function DevelopersPage() {
  return (
    <MainLayout>
      <SEO title="Loadify Developers | Commerce Integration Context" description="Technical overview of Loadify's controlled commerce integration model for supplier and technology connectivity discussions." canonical="/developers" />
      <main id="main-content" className="bg-[#F8F7F4] text-[#0A234F] md:pt-[122px]">
          ...
          <div className="mx-auto grid max-w-[1480px] gap-12 px-5 py-16 sm:px-7 lg:grid-cols-12 lg:items-center lg:px-10 lg:py-24">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-[26px] border border-[#0A234F]/10 bg-[#0A234F] p-7 text-white shadow-[0_22px_65px_rgba(10,35,79,0.14)]">
                ...
                <h2 className="mt-3 font-serif text-3xl tracking-[-0.025em]">Controlled, not self-service.</h2>
                <div className="mt-6 space-y-3 text-sm leading-6 text-white/72">
                  <p><strong className="text-white">Public API:</strong> not currently presented as generally available.</p>
                  <p><strong className="text-white">Public sandbox:</strong> not presented as generally available.</p>
                  <p><strong className="text-white">Webhooks:</strong> availability depends on the authorised integration path and verified provider capability.</p>
                  <p><strong className="text-white">Custom connectivity:</strong> considered according to commercial fit, technical evidence and capability requirements.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-[#0A234F] py-16 text-white sm:py-20">
          <div className="mx-auto max-w-[1180px] px-5 text-center sm:px-7">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-white/70">Share the system, commercial relationship and exact capabilities you want to connect. Loadify can then assess whether there is an appropriate technical path.</p>
