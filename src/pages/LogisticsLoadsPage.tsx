  ...
  const benefits = [
    {
      ...
      description:
        'Every carrier and broker on XDrive Market Logistics by XDrive Logistics Ltd is manually reviewed. Post with confidence knowing your load reaches trusted professionals.',
    },
    {
      icon: Clock,
    ...
    <div className="bg-jet min-h-screen">
      ...
      <section className="py-16 bg-jet">
        <div className="container-cinematic">
          <div className="text-center mb-12">
            <h2 className="heading-section text-white mb-4">
              Why Use <span className="text-gradient-gold">XDrive Market Logistics by XDrive Logistics Ltd</span>
            </h2>
            <p className="text-white/60 text-lg max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-graphite/30 relative overflow-hidden">
        ...
        <div className="container-cinematic relative z-10 text-center">
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto mb-10">
            Join thousands of UK logistics professionals on XDrive Market Logistics by XDrive Logistics Ltd today.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/catalog?type=logistics"
