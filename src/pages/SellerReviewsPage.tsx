    ...
    return (
      <div className="bg-jet min-h-screen pt-24 flex items-center justify-center">
        <div className="card-glass text-center py-12 px-8">
          <p className="text-white/60 mb-4">Sign in to view your seller reviews.</p>
  ...
  return (
    <div className="bg-jet min-h-screen pt-24">
      <div className="container-cinematic py-10 max-w-5xl">
        {/* Back */}
        <Link to="/seller" className="flex items-center gap-2 text-white/40 hover:text-gold transition-colors text-sm mb-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/40 text-sm mt-1">{reviews.length} total review{reviews.length !== 1 ? 's' : ''}</p>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="card-glass text-center py-20">
            ...
            <p className="text-white/40">Your product reviews will appear here once customers leave feedback.</p>
          </div>
        ) : (
                  ...
                  {isResponding && (
                    <div className="mt-3 pt-3 border-t border-white/10">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-white/30 text-xs">{responseText.length}/500</span>
