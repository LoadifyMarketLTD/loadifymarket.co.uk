      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> All listings require admin approval before they become visible to buyers. 
            Save as draft to continue editing later, or publish to submit for approval.
          </p>
        </div>
      </div>
    </div>
