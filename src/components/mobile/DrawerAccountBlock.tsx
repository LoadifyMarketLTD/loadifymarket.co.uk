    ...
    return (
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-[#D4AF37]/20 border border-[#D4AF37]/40 flex items-center justify-center text-[#D4AF37] font-bold text-sm shrink-0">
            {initial}
          </div>
        ...
        <div className="space-y-0.5">
          <Link
            to={dashboardPath}
            onClick={onClose}
            className="flex items-center gap-3 px-3 h-11 rounded-lg text-sm font-medium text-white/80 hover:text-[#D4AF37] hover:bg-white/[0.07] transition-colors"
          >
        ...
        <div className="flex gap-2 pt-1">
          {user.role !== "admin" && user.role !== "seller" && (
            <Button
              size="sm"
              className="flex-1 h-10 bg-[#D4AF37] hover:bg-[#D8AE57] text-black font-semibold rounded-full shadow-lg transition-all duration-300"
              asChild
            >
    ...
    <div className="p-4">
      <div className="flex gap-2">
        <Button
          variant="ghost"
          size="sm"
          className="flex-1 h-11 text-white/80 hover:text-[#D4AF37] hover:bg-white/10 font-medium"
          asChild
        >
        ...
        <Button
          size="sm"
          className="flex-1 h-11 bg-[#D4AF37] hover:bg-[#D8AE57] text-black font-semibold rounded-full shadow-lg transition-all duration-300"
          asChild
        >
