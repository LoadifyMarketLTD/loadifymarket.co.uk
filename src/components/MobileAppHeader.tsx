...
export default function MobileAppHeader() {
  ...
  return (
    <>
      <header
        className="sticky top-0 z-[60] border-b border-white/10 bg-[#0A234F] text-white shadow-[0_3px_18px_rgba(10,35,79,0.18)]"
        style={{
      ...
      >
        <div className="flex min-h-[54px] items-center justify-between gap-3">
          ...
          <button
            ...
            className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/20 bg-white p-0"
          >
            <Bell className="h-5 w-5 text-[#0A234F]" strokeWidth={2} aria-hidden="true" />
            {unread > 0 && (
              <span
                aria-hidden="true"
                className="absolute -right-0.5 -top-0.5 flex min-w-[17px] items-center justify-center rounded-full border-2 border-[#0A234F] bg-[#F5A300] px-0.5 text-[9px] font-black text-[#0A234F]"
                style={{ height: 17 }}
              >
                {unread > 9 ? '9+' : unread}
              </span>
        ...
        <div className="mt-3 flex items-center gap-2">
          <button
            ...
            className="flex h-12 min-w-0 flex-1 items-center gap-2.5 rounded-[14px] border border-white/15 bg-white px-3.5 text-left"
          >
          ...
          <button
            ...
            className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[14px] border border-white/15 bg-white"
          >
