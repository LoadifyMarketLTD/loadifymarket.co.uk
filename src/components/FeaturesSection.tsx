...
const WHY_CARDS = [
  {
    ...
    img: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=600&q=75&fm=webp",
    href: "/catalog",
  },
  {
    id: "wc-secure",
    title: "Safe & Secure",
    desc: "Stripe-powered checkout. 0% commission until 31 August, then 7%. Sellers go through an approval process before going live.",
    img: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=600&q=75&fm=webp",
    href: "/catalog",
  },
  {
    id: "wc-sell",
    ...
    img: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=600&q=75&fm=webp",
    href: "/signup",
  },
];
