  ...
  return (
    ...
    >
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 h-[60px] md:h-[72px] flex items-center gap-4">
        ...
        <button
          className="p-2.5 text-[#CBD5E1] bg-white/[0.10] hover:text-[#D4AF37] hover:bg-white/[0.18] active:bg-white/[0.22] rounded-xl transition-all shrink-0 ring-1 ring-white/20"
        ...
        <Link to="/" aria-label="Loadify Market — Home" className="flex items-center gap-2.5 shrink-0 ml-0.5">
          ...
          <span className="flex flex-col leading-tight">
            ...
            <span className="hidden sm:block font-display text-[13px] font-bold text-[#D4AF37] tracking-tight">Market</span>
          </span>
        </Link>
        ...
        <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-2xl mx-auto min-w-0">
          <div className="relative flex items-center w-full">
            ...
            <button
              type="submit"
              className="absolute right-1.5 top-1/2 -translate-y-1/2 h-8 sm:h-[34px] px-3 sm:px-5 bg-gradient-to-br from-[#D4AF37] to-[#D4AF37] hover:-translate-y-0.5 hover:shadow-[0_0_18px_rgba(251,191,36,0.25)] text-[#0A0E1A] text-xs sm:text-[13px] font-bold rounded-xl transition-all duration-250"
              aria-label="Search"
            >
        ...
        <Link
          to="/cart"
          className="lg:hidden relative p-2.5 text-[#CBD5E1] hover:text-[#D4AF37] hover:-translate-y-0.5 hover:drop-shadow-[0_0_7px_rgba(251,191,36,0.35)] hover:bg-white/10 rounded-xl transition-all shrink-0"
          aria-label="Shopping cart"
        >
          <ShoppingCart className="h-5 w-5" />
          {cartCount > 0 && (
            <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] rounded-full bg-[#D4AF37] text-white text-[10px] font-bold flex items-center justify-center px-0.5">
              {cartCount}
            </span>
          )}
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-1.5 shrink-0">
          <Link
            to="/cart"
            className="relative p-2.5 text-[#CBD5E1] hover:text-[#D4AF37] hover:-translate-y-0.5 hover:drop-shadow-[0_0_7px_rgba(251,191,36,0.35)] hover:bg-white/10 rounded-xl transition-all"
            aria-label="Shopping cart"
          >
            <ShoppingCart className="h-5 w-5" />
            {cartCount > 0 && (
          ...
          {user ? (
            <>
              <Button variant="ghost" size="sm" className="text-[#9CA3AF] hover:text-[#D4AF37] hover:bg-white/10 font-medium rounded-xl transition-all" asChild>
                <Link to={dashboardPath}>
                  <LayoutDashboard className="h-4 w-4 mr-1.5" aria-hidden="true" />
                  {user.role === "admin" ? "Admin Hub" : "Dashboard"}
                </Link>
              </Button>
              <Button variant="ghost" size="sm" className="text-[#9CA3AF] hover:text-[#D4AF37] hover:bg-white/10 font-medium rounded-xl transition-all" onClick={handleLogout}>
            ...
            <>
              ...
              <Button
                size="sm"
                className="h-9 bg-gradient-to-br from-[#D4AF37] to-[#D4AF37] border border-[rgba(251,191,36,0.35)] text-[#0A0E1A] font-bold px-5 rounded-xl shadow-[0_6px_16px_rgba(251,191,36,0.25)] hover:-translate-y-0.5 hover:shadow-[0_0_22px_rgba(251,191,36,0.28),0_10px_24px_rgba(0,0,0,0.40)] transition-all duration-250 ml-1"
                asChild
              >
                ...
                return (
                  ...
                  >
                    <Link
                      to={link.to}
                      className={[
                        "nav-cat-link text-[13px] font-semibold text-[#E5E7EB] hover:text-[#D4AF37] hover:-translate-y-px hover:[text-shadow:0_0_8px_rgba(251,191,36,0.25)] hover:bg-white/[0.08] px-3 py-2 rounded-lg transition-all duration-200 whitespace-nowrap text-center w-full",
                        isHovered ? "bg-white/[0.08] text-[#D4AF37]" : "",
                      ].join(" ")}
                    >
                      {link.label}
                    </Link>
