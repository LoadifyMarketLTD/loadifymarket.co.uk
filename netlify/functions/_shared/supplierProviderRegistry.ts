...
const DEFINITIONS: Record<SupplierProviderKey, SupplierProviderDefinition> = {
  ...
  syncee: {
    ...
    requiresProviderOrPartnerApproval: true,
    notes: 'Provider-neutral supplier-network candidate. Keep fail-closed until Loadify has explicit retailer-side access, compatible commercial terms and runtime capability evidence.',
  },
  appscenic: {
    key: 'appscenic',
    label: 'AppScenic',
