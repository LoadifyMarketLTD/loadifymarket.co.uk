 ...
 * Stripe Account.country is also persisted as server-captured tax-country
 * evidence. User-entered address/postcode data is never promoted to tax-country
 * evidence by this endpoint.
 */
