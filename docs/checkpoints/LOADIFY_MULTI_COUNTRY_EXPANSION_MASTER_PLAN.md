...
- dedicated buyer route `/buyer/withdrawal` with the Romanian presentation `Retrage+�i-v-� din contract aici`;
- explicit consumer confirmation action `Confirma+�i retragerea`;
