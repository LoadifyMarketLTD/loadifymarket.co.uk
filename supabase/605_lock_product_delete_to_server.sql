...
--
-- The delete decision itself is atomic in PostgreSQL. The product row is locked
-- before ownership/history checks so concurrent FK-backed marketplace activity
-- cannot appear between the retained-history check and DELETE.
