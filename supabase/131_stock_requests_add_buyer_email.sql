...
-- IF EXISTS guards, policies are dropped then re-created).
-- ================================================================
...
-- Policies: drop-then-recreate keeps this idempotent without PL/pgSQL
DROP POLICY IF EXISTS "stock_requests_insert_anon" ON stock_requests;
...
DROP POLICY IF EXISTS "stock_requests_select_sellers" ON stock_requests;
...
DROP POLICY IF EXISTS "stock_requests_select_own" ON stock_requests;
